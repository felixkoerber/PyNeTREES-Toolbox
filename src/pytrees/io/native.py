...
def load_tree(path: str | Path, **kwargs) -> Tree | list[Tree]:
    ...
    ==========  ============================================================
    ``.npz``    pytrees' own lossless format (:func:`save_npz`)
    ``.mtr``    MATLAB tree archive -- also ``.mat``
    ``.swc``    the standard SWC text format
    ``.neu``    NEURON transfer format (see :func:`~pytrees.io.load_neu`)
    ...
    It also applies :func:`~pytrees.repair_tree` automatically to
...
def save_tree(tree: Tree | list[Tree], path: str | Path, **kwargs) -> Path:
    ...
    ==========  ============================================================
    ``.npz``    pytrees' own lossless format -- the default and the only one
