...
:mod:`pynetrees.neuron_bridge` builds the same sections *in process* through
...
def _hoc_header(write: _Writer, stem: str, style: str) -> None:
    ...
    write("by pynetrees, the Python port of the TREES toolbox")
